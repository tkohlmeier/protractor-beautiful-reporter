...
function formatTotalTime(msecs){
    var diffSeconds = msecs / 1000;
    // diffSeconds = Number(diffSeconds);
    // 60*60
    var h = Math.floor(diffSeconds / 3600);
    var m = Math.floor(diffSeconds % 3600 / 60);
    var s = Math.floor(diffSeconds % 3600 % 60);
...
app.controller('ScreenshotReportController', function ($scope, $http) {
    ...
    this.formatTotalTime = function(msecs){
        var diffSeconds = msecs / 1000;
        // diffSeconds = Number(diffSeconds);
        // 60*60
        var h = Math.floor(diffSeconds / 3600);
